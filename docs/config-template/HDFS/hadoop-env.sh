...
# Include SSM libs
export HADOOP_CLASSPATH=$HADOOP_CLASSPATH:/root/smart-data-1.5.0/lib/smart*
...
# export HADOOP_OPTIONAL_TOOLS="hadoop-aliyun,hadoop-azure-datalake,hadoop-kafka,hadoop-aws,hadoop-openstack,hadoop-azure"
