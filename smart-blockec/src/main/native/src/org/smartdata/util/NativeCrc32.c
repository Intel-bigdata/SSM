...
#include "org_smartdata_erasurecode_util_NativeCrc32.h"
...
static int convert_java_crc_type(JNIEnv *env, jint crc_type) {
  switch (crc_type) {
    case org_smartdata_erasurecode_util_NativeCrc32_CHECKSUM_CRC32:
      return CRC32_ZLIB_POLYNOMIAL;
    case org_smartdata_erasurecode_util_NativeCrc32_CHECKSUM_CRC32C:
...
JNIEXPORT void JNICALL Java_org_smartdata_erasurecode_util_NativeCrc32_nativeComputeChunkedSums
...
JNIEXPORT void JNICALL Java_org_smartdata_erasurecode_util_NativeCrc32_nativeVerifyChunkedSums
  (JNIEnv *env, jclass clazz,
    jint bytes_per_checksum, jint j_crc_type,
    jobject j_sums, jint sums_offset,
    jobject j_data, jint data_offset, jint data_len,
...
{
  Java_org_smartdata_erasurecode_util_NativeCrc32_nativeComputeChunkedSums(env, clazz,
    bytes_per_checksum, j_crc_type, j_sums, sums_offset, j_data, data_offset,
    data_len, j_filename, base_pos, JNI_TRUE);
}

JNIEXPORT void JNICALL Java_org_smartdata_erasurecode_util_NativeCrc32_nativeComputeChunkedSumsByteArray
  (JNIEnv *env, jclass clazz,
    jint bytes_per_checksum, jint j_crc_type,
