...
#include "org_smartdata_erasurecode_rawcoder_NativeXORRawEncoder.h"
...
Java_org_smartdata_erasurecode_rawcoder_NativeXORRawEncoder_initImpl
...
JNIEXPORT void JNICALL
Java_org_smartdata_erasurecode_rawcoder_NativeXORRawEncoder_encodeImpl(
...
JNIEXPORT void JNICALL
Java_org_smartdata_erasurecode_rawcoder_NativeXORRawEncoder_destroyImpl
