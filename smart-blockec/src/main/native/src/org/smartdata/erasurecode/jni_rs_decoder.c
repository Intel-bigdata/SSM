...
#include "org_smartdata_erasurecode_rawcoder_NativeRSRawDecoder.h"
...
Java_org_smartdata_erasurecode_rawcoder_NativeRSRawDecoder_initImpl(
...
JNIEXPORT void JNICALL
Java_org_smartdata_erasurecode_rawcoder_NativeRSRawDecoder_decodeImpl(
...
JNIEXPORT void JNICALL
Java_org_smartdata_erasurecode_rawcoder_NativeRSRawDecoder_destroyImpl(
