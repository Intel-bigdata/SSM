...
class TestMoverProtection(unittest.TestCase):
    def test_mover_allssd_read(self):
        ...
        # Begin to move file
        cid_move = wait_for_cmdlet(move_cmdlet("allssd", file_path))
        # read the file
    ...
    def test_mover_onessd_read(self):
        ...
        file_path = create_random_file(1024 * 1024 * 1024)
        # Begin to move file
        cid_move = wait_for_cmdlet(move_cmdlet("onessd", file_path))
        # read the file
        cid_read = read_file(file_path)
        # check the statement of read
        self.assertTrue(all_success([cid_move]))
    ...
    def test_mover_archive_read(self):
        ...
        file_path = create_random_file(1024 * 1024 * 1024)
        # Begin to move file
        cid_move = wait_for_cmdlet(move_cmdlet("archive", file_path))
        # read the file
        cid_read = read_file(file_path)
        # check the statement of read
        self.assertTrue(all_success([cid_move]))
