...
for size in "${!CASES[@]}"; do
    ...
    hadoop jar $HADOOP_HOME/hadoop-mapreduce/hadoop-mapreduce-client-jobclient-*-tests.jar TestDFSIO -write -nrFiles $(($num)) -size ${size}  -resFile /home/hdfs/dfsio_mover_test.log
