...
public class CompileMojo extends AbstractMojo {
    ...
    @Parameter(
            defaultValue = "${project.build.directory}/native"
    )
    private File output;
    @Parameter(
            defaultValue = "${basedir}/src/main/native",
            required = true
    )
    private File source;
    @Parameter
    ...
    public void execute() throws MojoExecutionException {
        ...
        this.getLog().info("cmake compilation finished successfully in " + TimeUnit.MILLISECONDS.convert(end - start, TimeUnit.NANOSECONDS) + " millisecond(s).");
    }
