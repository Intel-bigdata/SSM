...
#include "org_smartdata_erasurecode_rawcoder_NativeXORRawDecoder.h"
...
Java_org_smartdata_erasurecode_rawcoder_NativeXORRawDecoder_initImpl(
...
JNIEXPORT void JNICALL
Java_org_smartdata_erasurecode_rawcoder_NativeXORRawDecoder_decodeImpl(
...
JNIEXPORT void JNICALL
Java_org_smartdata_erasurecode_rawcoder_NativeXORRawDecoder_destroyImpl
