...
/**
 * SmartDecompressorStream.
 */
public class SmartDecompressorStream extends DecompressorStream {
  private int originalBlockSize = 0;
  private int noUncompressedBytes = 0;

  /**
   * Create a SmartDecompressorStream.
   *
   ...
   * @throws IOException
   */
  public SmartDecompressorStream(InputStream in, Decompressor decompressor,
   ...
   * @throws IOException
   */
  public SmartDecompressorStream(InputStream in, Decompressor decompressor) throws IOException {
    super(in, decompressor);
  }

  protected SmartDecompressorStream(InputStream in) throws IOException {
    super(in);
  }
