...
public class SmartConfKeys {
  ...
  //EverSpan related
  public static final String EVERSPAN_BUCKET_PREFIX_KEY = "everspan.bucket.names";
  public static final String EVERSPAN_BUCKET_PREFIX_KEY_DEFAULT = "s3a://ssmBucket";
  public static final String EVERSPAN_PARTITION_NUM_BUCKETS_KEY = "everspan.partition.volume.size";
