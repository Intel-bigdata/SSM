...
public class SmartConfKeys {
  ...
  public final static String DFS_SSM_ENABLE_ZEPPELIN_WEB = "dfs.smart.zeppelin.web.enable";
  public final static boolean DFS_SSM_ENABLE_ZEPPELIN_WEB_DEFAULT = true;
