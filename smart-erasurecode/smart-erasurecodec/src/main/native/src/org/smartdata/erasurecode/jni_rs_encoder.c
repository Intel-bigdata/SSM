...
#include "org_smartdata_erasurecode_rawcoder_NativeRSRawEncoder.h"
...
Java_org_smartdata_erasurecode_rawcoder_NativeRSRawEncoder_initImpl(
...
JNIEXPORT void JNICALL
Java_org_smartdata_erasurecode_rawcoder_NativeRSRawEncoder_encodeImpl(
...
JNIEXPORT void JNICALL
Java_org_smartdata_erasurecode_rawcoder_NativeRSRawEncoder_destroyImpl(
