...
public class MoverPool {
  ...
  private Map<UUID, ActionStatus> moverMap;
  ...
  public UUID createMoverAction(String path) {
    ...
    LOG.info("Create a new move action with id = {}, path = {}", id, path);
    ActionStatus status = new MoverStatus(id);
   ...
   */
  public ActionStatus getStatus(UUID id) {
