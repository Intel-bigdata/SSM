...
public class SSMShell extends Configured implements Tool {

  static final Log LOG = LogFactory.getLog(SSMShell.class);
   ...
   */
  public SSMShell(Configuration conf) {
    super(conf);
  }
  ...
  protected void registerCommands(CommandFactory factory) {
    factory.registerCommands(SSMCommand.class);
  }
   ...
   */
  protected class Usage extends SSMCommand {
   ...
   */
  protected class Help extends SSMCommand {
  ...
  public int run(String argv[]) throws Exception {
    init();
    Tracer tracer = new Tracer.Builder("SSMShell").
  ...
  protected static SSMShell newShellInstance() {
    return new SSMShell();
  }
