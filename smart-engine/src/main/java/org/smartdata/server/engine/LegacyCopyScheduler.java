...
@Deprecated
public class LegacyCopyScheduler extends AbstractService {
  static final Logger LOG = LoggerFactory.getLogger(LegacyCopyScheduler.class);
  ...
  public LegacyCopyScheduler(ServerContext context) {
    super(context);
  ...
  public LegacyCopyScheduler(ServerContext context, CmdletManager cmdletManager,
